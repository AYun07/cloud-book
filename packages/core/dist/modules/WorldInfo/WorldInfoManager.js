...
class WorldInfoManager {
    ...
    storagePath;
    llmManager;
    constructor(storagePath = './data/worldinfo', llmManager) {
...
`);
     ...
     * 使用 LLM 自动生成世界设定内容
     */
    async generateWorldContent(projectId, options) {
     ...
     * 构建生成提示词
     */
    buildGenerationPrompt(genre, theme, storySeed, depth) {
...
- 输出必须是合法的 JSON 格式`;
     ...
     * 解析 LLM 生成的内容
     */
    async parseGeneratedContent(projectId, llmResponse, maxDepth) {
