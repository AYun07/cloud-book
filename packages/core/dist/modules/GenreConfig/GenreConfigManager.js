...
exports.GenreConfigManager = void 0;
class GenreConfigManager {
    ...
    validateCharacter(genre, character) {
        const template = this.templates.get(genre);
        if (!template) {
...
${template.powerSystem ? `【力量体系】\n${template.powerSystem}` : ''}
    ...
    updateTemplate(genre, updates) {
        const existing = this.templates.get(genre);
        if (existing) {
            this.templates.set(genre, { ...existing, ...updates });
        }
    }
    deleteTemplate(genre) {
        return this.templates.delete(genre);
    }
}
exports.GenreConfigManager = GenreConfigManager;
exports.default = GenreConfigManager;
//# sourceMappingURL=GenreConfigManager.js.map